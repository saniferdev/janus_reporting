...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_GET['date_debut'])){
        ...
        $tsql = "SELECT DISTINCT(DO_Piece) FROM (SELECT
                ...
                WHERE ".$_SESSION['where']." AND facture_ligne.statut = 0 AND facture_entete.DO_Provenance = 1)
                AS TabENT
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="get" action="AfficheRetour.php" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <table id="listeBon" name="listeBon" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                <tr ng-repeat="data in namesData | filter:numFacture">
                                    <td>{{ data.DO_Piece }}</td>
                                    <td><?php echo  $current_date_time->format("d/m/Y"); ?></td>
                                    <!-- <td>{{ data.DO_Ref }}</td>

                                             <td class="stat">{{ data.statut }}<!--<img src="images/status0.png" style="margin-left: 10px;"/></td>-->
                                    <td><a href="<?php echo $link; ?>/janus_v2/retour.php?numBont={{ data.DO_Piece }}">Details</a> </td>
