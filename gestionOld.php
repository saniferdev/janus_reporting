...
dbo.facture_entete.DO_Piece LIKE '%' + ? + '%'";*///= 02809025
      $tsql = "SELECT * FROM facture_entete fe
                 ...
                 WHERE fe.DO_Piece LIKE '%' + ? + '%' AND a.DL = '".$_SESSION['depot']."'";
                                        ...
                                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    ...
                                                    <a href="<?php echo $link; ?>/wms_test/gestion.php" class="btn btn-default">reset</a>
                                                        ...
                                                        <td><?php echo $val->FA_CodeFamille; ?></td>
                                                          ...
                                                          if($val->statut == 1) {
                                                              if ($val->DL == $_SESSION['depot']) {
                                                                  ...
                                                                  <td><input type="submit" value="Valider" name="valider" class="btn btn-primary valide <?php echo $val->DL; ?>" disabled>
                                                                  </td>
                                                              <?php
                                                              } else {
                                                                  ?>
